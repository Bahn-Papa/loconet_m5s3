...
#define OPC_MULTI_SENSE_ZONE_MASK		0x0F
...
//	loconet sensor/switch parameter
#define LN_THROWN_INT		0
#define LN_RED_INT			0
#define LN_CLOSED_INT		1
#define LN_GREEN_INT		1

#define LN_THROWN			false
#define LN_RED				false
#define LN_CLOSED			true
#define LN_GREEN			true

#define LN_OUTPUT_OFF		false
#define LN_OUTPUT_ON		true

#define LN_INPUT_HI			true
#define LN_INPUT_LO			false


#define LOCONET_OPC_MASK	0x80
